...
@interface SHWelcomePageController ()<UIScrollViewDelegate>

@property (nonatomic, strong)NSArray *imageArr;
@property (nonatomic, strong)UIViewController *rootVC;
@end

@implementation SHWelcomePageController
...
- (void)showRootControllerButtonClick{
    ...
    [userDefault setBool:YES forKey:SHWelcomeIsLaunchDefaultKey];
